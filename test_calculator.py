...
class TestCalculatorPage:
    '''
    Провяряем, что все поля отображаются при запуске приложения 
    '''
...
#         # Введите целое число в первое и второе поле ввода и убедитесь, что они правильно принимает вводимые данные.
